...
public interface ITypeMaterielDao extends JpaRepository<TypeMateriel, Long>, JpaSpecificationExecutor<TypeMateriel> {
    ...
    @Query("SELECT t FROM TypeMateriel t WHERE t.nom LIKE :nom and t.code LIKE :code")
    Page<TypeMateriel> searchLike(@Param("code") String code, @Param("nom") String nom,Pageable pageable);
